                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        onClick={() => {
                          ...
                          if (qrWindow) {
                            qrWindow.document.write(`<!DOCTYPE html><html><head><title>QR de ${student.name}</title></head><body style='display:flex;flex-direction:column;align-items:center;justify-content:center;height:100vh;margin:0;'><div id='qr-root'></div><div style='margin-top:16px;font-family:sans-serif;font-size:18px;color:#f97316;font-weight:bold;text-align:center'>${student.name}</div><script src='https://cdn.jsdelivr.net/npm/qrious@4.0.2/dist/qrious.min.js'></script><script>window.onload=function(){var qr=new QRious({element:document.createElement('canvas'),value:'${student.qrCode}',size:320,background:'white',foreground:'black'});document.getElementById('qr-root').appendChild(qr.element);}</script></body></html>`);
